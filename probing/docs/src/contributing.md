...
**Skills vs Python package:** edit skill **data** in repo-root `skills/`; edit skill **loader / install code** in `python/probing/skills/`. Do **not** edit `python/probing/_skills/` by hand — it is generated by `make wheel`.
...
- **Bundled in wheel**: `make wheel` copies into `python/probing/_skills/` and `python/probing/_web/`
...
│   │   ├── _skills/              # wheel GENERATED (make wheel) — do not edit
│   │   └── _web/                 # wheel GENERATED (make wheel) — do not edit
