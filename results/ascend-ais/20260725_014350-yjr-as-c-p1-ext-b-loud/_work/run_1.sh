...
unset PROBING PROBING_TORCH_PROFILING PROBING_GPU INLINE_INJECT 2>/dev/null || true; export PROBING=0; export INLINE_INJECT=hbm; export INLINE_VICTIM_LOCAL_RANK=7; export INLINE_INJECT_START=100; export INLINE_INJECT_STOP=300; export INLINE_HBM_MB=512; export INLINE_HBM_COPIES=48;
OUT='/data/yinjinrun.p-huawei/results/ascend-ais/20260725_014350-yjr-as-c-p1-ext-b-loud/P1-EXT-B/by_pod/yysong-master-0/round_1/C1_inject_none'
...
/root/miniconda3/envs/llm_test/bin/torchrun --nnodes=1 --nproc_per_node=16 --node_rank=0 \
  ...
  --run-id=20260725_014350-yjr-as-c-p1-ext-b-loud --group=1 --config='C1_inject_none' --round=1 \
