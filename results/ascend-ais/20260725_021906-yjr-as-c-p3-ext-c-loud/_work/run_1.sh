...
OUT='/data/yinjinrun.p-huawei/results/ascend-ais/20260725_021906-yjr-as-c-p3-ext-c-loud/P3-EXT-C/by_pod/yysong-master-0/round_1/C1_inject_none'
...
/root/miniconda3/envs/llm_test/bin/torchrun --nnodes=1 --nproc_per_node=16 --node_rank=0 \
  ...
  --run-id=20260725_021906-yjr-as-c-p3-ext-c-loud --group=1 --config='C1_inject_none' --round=1 \
