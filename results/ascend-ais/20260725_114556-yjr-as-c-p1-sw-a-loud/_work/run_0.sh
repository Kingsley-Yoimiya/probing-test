...
OUT='/data/yinjinrun.p-huawei/results/ascend-ais/20260725_114556-yjr-as-c-p1-sw-a-loud/P1-SW-A/by_pod/yysong-master-0/round_1/C0_baseline'
...
/root/miniconda3/envs/llm_test/bin/torchrun --nnodes=1 --nproc_per_node=16 --node_rank=0 \
  ...
  --run-id=20260725_114556-yjr-as-c-p1-sw-a-loud --group=0 --config='C0_baseline' --round=1 \
