...
unset PROBING PROBING_TORCH_PROFILING PROBING_GPU INLINE_INJECT 2>/dev/null || true; export PROBING=0; export INLINE_INJECT=2c; export INLINE_VICTIM_LOCAL_RANK=7; export INLINE_INJECT_START=100; export INLINE_INJECT_STOP=300; export INLINE_2C_N=1024; export INLINE_2C_EVERY=1; export INLINE_2C_FALLBACK_S=0.25;
OUT='/data/yinjinrun.p-huawei/results/ascend-ais/20260725_121105-yjr-as-c-p1-sw-c-loud/P1-SW-C/by_pod/yysong-master-0/round_1/C1_inject_none'
...
/root/miniconda3/envs/llm_test/bin/torchrun --nnodes=1 --nproc_per_node=16 --node_rank=0 \
  ...
  --run-id=20260725_121105-yjr-as-c-p1-sw-c-loud --group=1 --config='C1_inject_none' --round=1 \
