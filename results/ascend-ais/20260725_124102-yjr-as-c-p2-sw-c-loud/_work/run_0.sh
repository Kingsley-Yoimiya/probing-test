...
OUT='/data/yinjinrun.p-huawei/results/ascend-ais/20260725_124102-yjr-as-c-p2-sw-c-loud/P2-SW-C/by_pod/yysong-master-0/round_1/C0_baseline'
...
/root/miniconda3/envs/llm_test/bin/torchrun --nnodes=1 --nproc_per_node=16 --node_rank=0 \
  ...
  --run-id=20260725_124102-yjr-as-c-p2-sw-c-loud --group=0 --config='C0_baseline' --round=1 \
