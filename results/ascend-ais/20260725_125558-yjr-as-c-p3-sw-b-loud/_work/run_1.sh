...
unset PROBING PROBING_TORCH_PROFILING PROBING_GPU INLINE_INJECT 2>/dev/null || true; export PROBING=0; export INLINE_INJECT=8b; export INLINE_VICTIM_LOCAL_RANK=7; export INLINE_INJECT_START=100; export INLINE_INJECT_STOP=300; export INLINE_8B_MB=16; export INLINE_8B_STALL_S=0.25;
OUT='/data/yinjinrun.p-huawei/results/ascend-ais/20260725_125558-yjr-as-c-p3-sw-b-loud/P3-SW-B/by_pod/yysong-master-0/round_1/C1_inject_none'
...
/root/miniconda3/envs/llm_test/bin/torchrun --nnodes=1 --nproc_per_node=16 --node_rank=0 \
  ...
  --run-id=20260725_125558-yjr-as-c-p3-sw-b-loud --group=1 --config='C1_inject_none' --round=1 \
