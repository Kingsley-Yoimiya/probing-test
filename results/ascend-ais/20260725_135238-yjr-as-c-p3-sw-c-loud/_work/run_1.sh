...
OUT='/data/yinjinrun.p-huawei/results/ascend-ais/20260725_135238-yjr-as-c-p3-sw-c-loud/P3-SW-C/by_pod/yysong-master-0/round_1/C1_inject_none'
...
/root/miniconda3/envs/llm_test/bin/torchrun --nnodes=1 --nproc_per_node=16 --node_rank=0 \
  ...
  --run-id=20260725_135238-yjr-as-c-p3-sw-c-loud --group=1 --config='C1_inject_none' --round=1 \
