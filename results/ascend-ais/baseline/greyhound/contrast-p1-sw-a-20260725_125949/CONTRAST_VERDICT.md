# Greyhound Contrast · P1-SW-A Loud

- run_id: `contrast-p1-sw-a-20260725_125949`
- case_ref: `20260725_114556-yjr-as-c-p1-sw-a-loud`
- dose: INLINE 2a chunks=12 stall_mb=768 stall_s=0.25 victim=7; window [100,300]；窗对齐 Case [100,300]
- fairness: `collect_seq` 真实 per-rank 序列 + C0 假阳性对照
- detect_ok: **yes**；detect_mode: **autonomous**（自主= coll 比≥1.3 或 Rbeast 变点[C1有/C0无]）
- oracle_trigger: **no**（未把注入窗写入判定）；注入窗 [100,300] 仅标注；step_ms 窗比=4.283（剂量核对，非 Greyhound 规则）
...
**C1/C0 coll ratio = 1.009** → FAIL (thr 1.3)
...
|-----|---------:|--------:|---------:|-----------:|---------------:|
| C0  | 164504 | 4401 | 10 | 8 | 0 |
| C1  | 168782 | 4401 | 10 | 8 | 2 |

- C1 changepoints: [{'id': 208, 't': 29.13788604736328}, {'id': 324, 't': 83.00433802604675}]
- C0 changepoints: []
...
Note: P1-SW-A 注入下 Greyhound 主路径是 CCL 时间戳+变点。若 coll/Rbeast 无咬合而 step_ms 有抬升，记能力边界，不焊 D4。
